...
return <div className="App">
  ...
  showLabels
>
  <BottomNavigationAction label="Recents" icon={<PictureAsPdfIcon />} />
  <BottomNavigationAction label="Favorites" icon={<PictureAsPdfIcon />} />
  <BottomNavigationAction label="Nearby" icon={<PictureAsPdfIcon />} />
</BottomNavigation>
      </div>
}
